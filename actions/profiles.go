...
func (v ProfilesResource) Show(c buffalo.Context) error {
	...
	if err := tx.Find(profile, c.Param("profile_id")); err != nil {
		return c.Error(404, err)
	}

	return c.Render(200, r.Auto(c, profile))
}

// New renders the form for creating a new Profile.
// This function is mapped to the path GET /profiles/new
func (v ProfilesResource) New(c buffalo.Context) error {
	return c.Render(200, r.Auto(c, &models.Profile{}))
}
...
func (v ProfilesResource) Create(c buffalo.Context) error {
	...
	if verrs.HasAny() {
		...
		// correct the input.
		return c.Render(422, r.Auto(c, profile))
	}
	...
	return c.Render(201, r.Auto(c, profile))
}

// Edit renders a edit form for a Profile. This function is
...
func (v ProfilesResource) Destroy(c buffalo.Context) error {
	...
	if err := tx.Destroy(profile); err != nil {
		return errors.WithStack(err)
	}
